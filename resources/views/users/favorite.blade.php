                 ...
                 <div class="col-md-7 mt-2">
                     <div class="d-inline-flex">
                         ...
                         <div class="container mt-3">
                             <h5 class="w-100 samuraimart-favorite-item-text">{{ $favorite_restaurant->name }}</h5>
                             <h6 class="w-100 samuraimart-favorite-item-text">&yen;{{ $favorite_restaurant->price }}</h6>
                         </div>
                     </div>
                 </div>
                 <div class="col-md-2 d-flex align-items-center justify-content-end">
                     <a href="{{ route('favorites.destroy', $favorite_restaurant->id) }}" class="samuraimart-favorite-item-delete" onclick="event.preventDefault(); document.getElementById('favorites-destroy-form').submit();">
                         削除
                     </a>
